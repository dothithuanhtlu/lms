...
public interface IAssignmentService {
    ...
    AssignmentDTO updateAssignment(Long assignmentId, AssignmentCreateDTO updateDTO);
    ...
    List<AssignmentDTO> getAssignmentsByType(Long courseId, Assignment.AssignmentType type);
