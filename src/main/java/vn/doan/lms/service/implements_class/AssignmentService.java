...
public class AssignmentService implements IAssignmentService {
    ...
    // .orElseThrow(
    // () -> new ResourceNotFoundException("Course not found with id: " +
    ...
    // .allowLateSubmission(
    // createDTO.getAllowLateSubmission() != null ?
    // createDTO.getAllowLateSubmission() : false)
    // .isPublished(createDTO.getIsPublished() != null ? createDTO.getIsPublished()
    // : false)
    // .build();
    ...
    // @Override
    // public AssignmentDTO updateAssignment(Long assignmentId, AssignmentCreateDTO
    // updateDTO) {
    // Assignment assignment = assignmentRepository.findById(assignmentId)
    // .orElseThrow(() -> new ResourceNotFoundException("Assignment not found with
    // id: " + assignmentId));
    ...
    // throw new ResourceNotFoundException("Assignment not found with id: " +
    // assignmentId);
    // }
    ...
    // @Override
    // public List<AssignmentDTO> getAssignmentsByType(Long courseId,
