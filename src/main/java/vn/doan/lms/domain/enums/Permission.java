...
public enum Permission {
    ...
    VIEW_USER_STATISTICS("VIEW_USER_STATISTICS", HttpMethod.GET, "/admin/users/statistics", "Xem thống kê người dùng"),
    ...
    VIEW_STUDENT_DETAILS("VIEW_STUDENT_DETAILS", HttpMethod.GET, "/admin/student/{userCode}", "Xem chi tiết sinh viên"),
    VIEW_TEACHER_DETAILS("VIEW_TEACHER_DETAILS", HttpMethod.GET, "/admin/teacher/{userCode}", "Xem chi tiết giáo viên"),
    ...
    // Student scores
    VIEW_STUDENT_SCORES("VIEW_STUDENT_SCORES", HttpMethod.GET, "/admin/courses/{courseId}/students/{studentId}/scores",
    ...
    UPDATE_LESSON_WITH_FILES("UPDATE_LESSON_WITH_FILES", HttpMethod.PUT, "/api/lessons/{lessonId}/update-with-files",
    ...
    // ================================
    CREATE_ASSIGNMENT("CREATE_ASSIGNMENT", HttpMethod.POST, "/api/assignments/create-with-files", "Tạo bài tập mới"),
    ...
    PUBLISH_ASSIGNMENT("PUBLISH_ASSIGNMENT", HttpMethod.PUT, "/api/assignments/{assignmentId}/publish",
            "Xuất bản bài tập"),
    DELETE_ASSIGNMENT("DELETE_ASSIGNMENT", HttpMethod.DELETE, "/api/assignments/delete/{assignmentId}", "Xóa bài tập"),
    ...
    GRADE_SUBMISSION("GRADE_SUBMISSION", HttpMethod.POST, "/api/submissions/{submissionId}/grade", "Chấm điểm bài nộp"),
