...
public interface AssignmentRepository extends JpaRepository<Assignment, Long> {
    ...
    Page<Assignment> filterAssignments(Long courseId, String keyword, Boolean isPublished, LocalDate startDate, LocalDate endDate, Boolean isLateSubmission, Pageable pageable);
