...
public class AssignmentController {
    ...
    public ResponseEntity<List<AssignmentDTO>> getPublishedAssignmentsByCourse(@PathVariable Long courseId) {
        List<AssignmentDTO> assignments = assignmentService.getPublishedAssignmentsByCourseId(courseId);
        return ResponseEntity.ok(assignments);
    }
    ...
    public ResponseEntity<List<AssignmentDTO>> getAssignmentsByType(
        ...
        List<AssignmentDTO> assignments = assignmentService.getAssignmentsByType(courseId, type);
        return ResponseEntity.ok(assignments);
    }
    ...
    @PostMapping
    public ResponseEntity<AssignmentDTO> createAssignment(@Valid @RequestBody AssignmentCreateDTO createDTO) {
    ...
    public ResponseEntity<Void> unpublishAssignment(@PathVariable Long assignmentId) {
